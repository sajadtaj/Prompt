...
پرامپت هر فاز باید خودکفا، حرفه‌ای، و آماده برای استفاده مستقیم باشد. فقط پرامپت‌های فازها را خروجی دهید، بدون توضیح اضافی. ان پرامپت را میخواهم به chat gpt بدهم.

هر فاز بصورت پرامپت شامل ساختار کامل تعریف و توضیخات و عناصر سازنده ان فاز است بگونه ای که اگر پرامپت فاز را به تو بدهم. تو با خواندن دقیق ان پرامپت میفهمی باید در ان فاز دقیقا چه کار کنی و مراحل اجرای ان فاز را قدم به قدم با جزییات کامل در خروجی بصورت چت تحویل میدهی.
...
-  تمام کانسپت های توسه داده شده در این فاز را در بگیر.
- ساختار در ختی پوشعه و فایلهای توسعه داده شده در این فاز
...
- کانسپت ها را کامل توضیخ بده با بیان روان و ثلیث
- از اصطلاخات تخصصی مبهم که ممکن است باعث گیج شدن شود بپرهیز
---
